...
- **Research Parsing**: Filter out preamble/reasoning text from Perplexity responses. Only valid tech stack options (short names, no preamble phrases) are shown in selection.
