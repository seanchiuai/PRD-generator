...
- **WorkflowStep Type**: Added 'setup' to WorkflowStep union type in WorkflowContext.tsx, progress.ts, workflow.ts, and schema.ts
...
- **ExtractedContext Placeholders**: Changed targetAudience to empty string and keyFeatures/technicalPreferences to undefined in saveProjectSetup. Made fields optional in Convex schema and TypeScript types.
