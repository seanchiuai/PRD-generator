...
- **PRD JSON Parsing**: Strengthened prompt with explicit JSON-only instructions. Added fallback JSON extraction to handle AI responses with conversational preambles.
