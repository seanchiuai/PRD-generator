...
function SignInForm() {
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute top-20 left-10 w-32 h-32 rounded-full bg-macaron-lavender/30 blur-3xl animate-float" style={{ animationDelay: '0s' }}></div>
      <div className="absolute bottom-20 right-10 w-40 h-40 rounded-full bg-macaron-mint/30 blur-3xl animate-float" style={{ animationDelay: '1s' }}></div>
      <div className="absolute top-1/2 right-1/4 w-24 h-24 rounded-full bg-macaron-rose/30 blur-3xl animate-float" style={{ animationDelay: '2s' }}></div>
      ...
      <div className="max-w-lg w-full relative z-10">
        <div className="text-center mb-12 animate-fade-in-up">
          ...
          <h1 className="text-5xl font-display font-bold mb-4 bg-gradient-to-r from-[#3D2066] via-[#1A4D3E] to-[#8B2952] bg-clip-text text-transparent">
            PRD Generator
          </h1>
        ...
        <div className="glass-effect rounded-3xl p-8 shadow-2xl animate-scale-in" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="mt-8 pt-8 border-t border-border">
            <div className="grid grid-cols-2 gap-6 text-sm">
              <div className="text-center">
                <div className="w-12 h-12 mx-auto mb-3 rounded-2xl bg-macaron-mint/20 flex items-center justify-center">
                  <Zap className="w-6 h-6 text-[#1A4D3E]" />
                </div>
              ...
              <div className="text-center">
                <div className="w-12 h-12 mx-auto mb-3 rounded-2xl bg-macaron-lavender/20 flex items-center justify-center">
                  <FileText className="w-6 h-6 text-[#3D2066]" />
                </div>
